<!-- This program maps the Illumina sequencing reads to the bacterial genome
...
//get sample position and find the corresponding gene name and function by comparing the start and end positions of the gene
foreach ($r2 as $k => $v) {
		$id 	= $r2[$k]['id'];
		$read   = $r2[$k]['reads'];
		$pos 	= $r2[$k]['insertion'];
